...
# 1 Install R package, RStudio, directory set-up, GitHub
...
![1](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Create_RStudio_Project.gif){width=50%}\
...
![data](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/data.png){width=15%}
Then we go to the File menu and select New File, then select R Script. This should open up a script editor in the top left hand corner. This is where we will be typing and saving all commands required for this analysis. 
Now save the file as DEA_script.R. When finished your working directory should now look similar to this:\
![directories](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/dir.png)
...
![2](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github3.png){width=50%}
...
![3](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github5.png){width=50%}
...
![4](C:/Users/timoi/OneDrive - University of Helsinki/ZilanWen Github/RNA-seq_Differential-Gene-Expression-Analysis/image/Github4.png){width=50%}
...
### 3.1.2 Using our dataset for PCA
...
## 3.2 Hierarchical Clustering Heatmap
...
Differential expression analysis can be carried out using DESeq2 or using EdgeR. The DESeq2 methods has been describes in [DGE workshop Salmon](https://github.com/hbctraining/DGE_workshop_salmon_online/blob/master/lessons/04a_design_formulas.md). Here we will learn to use another method -- EdgeR
